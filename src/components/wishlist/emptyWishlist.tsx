  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        ...
        {/* CTA Button */}
        <Link href="/products" className="cursor-pointer group flex items-center gap-3 bg-red-500 hover:bg-red-600 active:scale-95 text-white font-semibold text-base px-8 py-4 rounded-xl shadow-lg shadow-red-200 transition-all duration-200">
          Start Shopping
