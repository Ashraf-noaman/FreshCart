      ...
      <main>
        <div className='bg-gradient-to-r from-green-600 to-green-400 h-40 lg:h-55 lg:p-13 p-10'>
          ...
          <div className='flex items-center gap-5'>
            ...
            <div className='mt-2'>
              <h3 className='lg:text-4xl text-2xl font-bold text-white'>All Products</h3>
              <p className='text-white/90'>Explore our complete product collection</p>
            </div>
          </div>
        </div>
        ...
        <div className='container mx-auto pt-8'>
          <div className="grid mb-10 grid-cols-2 md:grid-cols-3 lg:grid-cols-5 lg:px-10 gap-5 px-4 cursor-pointer">
                  ...
                  <React.Fragment key={product._id}>
                    ...
                    <Image src={product.imageCover} className='w-40 h-40 lg:w-50 object-contain lg:h-60 mx-auto' width={1000} height={1000} alt='product '/>
                    <CardHeader>
                      <div className="card-brand text-gray-600 text-sm">
                        {product.brand.name}
                      </div>
                      <CardTitle className='text-lg font-bold'>{product.title}</CardTitle>
                      <CardDescription className='card-brand text-gray-400 text-sm'>{product.category.name}</CardDescription>
                          ...
                          {[0,1,2,3,4].map((star,index)=>{
                            ...
                            return(
                              <React.Fragment key={index}>
                                <Star className={filledStars ? "text-yellow-400 fill-yellow-400 cursor-pointer w-4 h-4 lg:w-6 lg:h-6" : "text-gray-400 fill-gray-400 cursor-pointer w-4 h-4 lg:w-6 lg:h-6"} />
                              </React.Fragment>
                            )
                          })}
                      </div>
