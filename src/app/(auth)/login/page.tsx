...
import { Headset, ShieldBan, Truck, Facebook, UserPlus, Lock, Users, Star, RotateCw } from 'lucide-react';
    ...
    <>
      <div className='grid lg:grid-cols-2 lg:py-15 lg:mx-30 lg:gap-10 grid-cols-1 py-10 mx-5 gap-20'>
        <div className=' hidden lg:flex lg:flex-col lg:justify-center'>
          <Image src={loginbg} alt='loginImage' width={1000} height={1000} className='w-full h-full rounded-5xl  bg-contain' />
          <h3 className=' text-3xl font-bold text-center'>FreshCart - Your One-Stop Shop for Fresh Products</h3>
          <h3 className=' text-lg  text-center'>Join thousands of happy customers who trust FreshCart for their daily grocery needs</h3>
         ...
         <div className='flex flex-col justify-center items-center p-4 shadow-lg rounded-xl'>
          <h3 className='text-center text-3xl font-bold leading-12'><span className='text-green-600'>Fresh</span>Cart<br/> Welcome Back!</h3>
          <p className='text-gray-700 my-1'>Sign in to continue your fresh shopping experience</p>
          ...
          <div className='flex gap-4 items-center w-full'>
            ...
            <span className='text-gray-600 text-sm'>OR CONTINUE WITH EMAIL</span>
            <div className=' bg-gray-100 grow h-[3]'></div>
          </div>
          <div className='card w-full'>
          <form onSubmit={form.handleSubmit(handelLogin)} className='space-y-7'>
          ...
          <Controller  
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <Link href="/forgotPass" className='text-green-600 hover:text-green-700'>
                    Forgot Password?
                  </Link>
                  </div>
                  <Input
            ...
            <Checkbox id="terms-checkbox" className="data-[state=checked]:bg-green-600 data-[state=checked]:border-green-600" name="terms-checkbox" />
            ...
            <Button className="bg-green-600 text-white cursor-pointer flex items-center justify-center gap-3 w-full px-4 py-2 border rounded-lg shadow-sm hover:bg-green-700 transition" type="submit"> Login In</Button>
          </form>
